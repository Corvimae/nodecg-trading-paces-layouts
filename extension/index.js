...
})({"jhvpA":[function(require,module,exports,__globalThis) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SERVER_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "ed23c822fab81051";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "b4d761ca637cb757";
"use strict";
...
},{}],"c3SbJ":[function(require,module,exports,__globalThis) {
...
module.exports = (nodecg)=>{
    async function fetchFromTracker(path) {
        ...
        try {
            ...
            if (response.next) return [
                ...response.results,
                ...await fetchFromTracker(response.next)
            ];
    ...
    const bidTree = nodecg.Replicant('bidTree', 'nodecg-trading-paces-layouts', {});
    async function fetchBids() {
        try {
            const allBids = await fetchFromTracker(`events/${nodecg.bundleConfig.trackerEvent}/bids/tree.json`);
    ...
    const omnibarState = nodecg.Replicant('nodecg-omnibar', 'nodecg-omnibar', {});
    const previousCarouselItemId = {
        value: ''
    };
    function requestIncentivePlan(force = false) {
        ...
        if (force || omnibarState.value.activeCarouselItemId !== previousCarouselItemId.value) {
            ...
            nodecg.sendMessageToBundle('requestIncentivePlan', 'nodecg-trading-paces-layouts', bidTree.value?.filter((bid)=>Number(bid.speedrun) === Number(currentRunItem.data.trackerId)) ?? []);
        }
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"kGC6c"}],"kGC6c":[function(require,module,exports,__globalThis) {
...
},{}]},["jhvpA","c3SbJ"], "c3SbJ", "parcelRequire8d03", {})
